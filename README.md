...
- [📖 About the Project](#about-project)
  - [🛠 Built With](#built-with)
    ...
    - [Walkthrough to the Book Store](#key-features)
  <!-- - [🚀 Live Demo](#live-demo) -->
...
**[Book Store]** This project will lay the foundations for the Bookstore website. 
...
```sh
  cd my-folder
  git git@github.com:LarryIVC/bookstore.git
```
...
Feel free to check the [issues page](https://github.com/LarryIVC/bookstore/issues).
...
Help me with your criticisms and your suggestions, you will be blessed for such a noble gesture and give me a ⭐️ if you like this project. click [here ⭐️](https://github.com/LarryIVC/bookstore/stargazers)
